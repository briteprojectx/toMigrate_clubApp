...
import { ServerInfoActions } from '../../../redux/server';
import { SessionActions, SessionDataService } from '../../../redux/session';
import { ScorerStateActions, ScorerStateDataService, ScoringStage } from '../../../redux/scorer-state';
 ...
 */
@Component({
    templateUrl: 'competition-scoring-list.html',
    selector: 'competition-scoring-list-page'
})
export class CompetitionScoringListPage
{
    ...
    private session$: Observable<SessionInfo>;
    private showLoginForm: Observable<boolean>;
    private sessionState$: Observable<SessionState>;
    private loggedIn$: Observable<boolean>;
    private refreshTried$: Observable<boolean>;
    private totalComps$: Observable<number>;
    private activeCompetitions$: Observable<CompetitionInfo[]>;
